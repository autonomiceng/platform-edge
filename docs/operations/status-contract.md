...
| `version` | The configured tag as shipped, including any leading `v`, when a component-specific allowlist recognizes it as a release, matching `^[A-Za-z0-9._+-]{1,128}$`; null otherwise. |
